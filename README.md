...
- Personas created using the open source GPT-2: [GPT-2 personas](https://github.com/patriciaschaffer/blob/main/gpt2/README.md)
- Personas created using the open source Mistral-7B-Instruct-v0.1-GGUF: [Mistral personas](https://github.com/patriciaschaffer/blob/main/mistral/README.md)
